...
class CreateRotaTable extends Migration
{
    ...
    public function up()
    {
        $sql = "
            ...
            INSERT INTO `rota_slot_staff` (`id`, `rotaid`, `daynumber`, `staffid`, `slottype`, `starttime`, `endtime`, 
        ...
        if (App::environment('testing')) {
            Schema::create('rota_slot_staff', function (Blueprint $table) {
                ...
                $table->string('slottype', 20)->nullable();
                $table->time('starttime')->nullable();
                $table->time('endtime')->nullable();
                $table->float('workhours', 4, 2)->nullable();
                $table->tinyInteger('premiumminutes')->nullable();
                $table->integer('roletypeid')->nullable();
                $table->tinyInteger('freemiumminutes')->nullable();
                $table->tinyInteger('seniorcashierminutes')->nullable();
                $table->integer('splitshifttimes')->nullable();
            });
        } else {
    ...
    {
        DB::connection()->getPdo()->exec('DROP TABLE rota_slot_staff');
    }
}
